...
export const Testimonials: React.FC = () => {
  ...
  return (
    <section id="results" className={`py-20 md:py-32 ${dimension === 'growth' ? 'bg-gray-100' : 'bg-propello-dim'}`}>
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row gap-10 md:gap-16 items-center">
            <div className="w-full md:w-1/3 text-center md:text-left">
                <h2 className="text-3xl md:text-4xl font-bold mb-4 md:mb-6">Real Results.<br/>Real Revenue.</h2>
            ...
            <div className="w-full md:w-2/3">
                <div className={`p-8 md:p-12 rounded-3xl relative ${dimension === 'growth' ? 'bg-white shadow-2xl' : 'bg-white/5 border border-white/10'}`}>
                    <Quote className={`absolute top-6 left-6 md:top-10 md:left-10 opacity-10 ${dimension === 'growth' ? 'text-black' : 'text-white'}`} size={80} />
                    
                    <p className="text-xl md:text-2xl lg:text-4xl font-serif italic font-light leading-relaxed relative z-10 mb-8">
